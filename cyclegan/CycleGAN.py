...
class cyclegan:
    def generate(img,reuse=False,scope='generate'):
        ...
        with tf.variable_scope(scope,reuse=reuse):
            ...
            layer_10 = instance_norm(layer_10,scope='G_ins_10')
            layer_10 = relu(layer_10)

            layer_11 = deconv(layer_10,64,kernel=3,stride=2,scope='G_layer_11')
            layer_11 = instance_norm(layer_11,scope='G_ins_11')
    ...
    def discriminate(img,reuse=False,scope='discriminate'):
        with tf.variable_scope(scope, reuse=reuse):
            #128x128x64
